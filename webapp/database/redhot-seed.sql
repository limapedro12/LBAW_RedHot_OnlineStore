...
INSERT INTO Produto (nome, descricao, precoAtual, desconto, stock, id_administrador) VALUES
  ('Pimenta Malagueta', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 3.99, 5, 100, 1),
  ('Molho de Piri-Piri', 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 4.50, 3, 75, 2),
  ('Canela em Pau', 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.', 6.25, 0, 250, 3),
  ('Paprica Doce', 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.', 8.75, 2, 150, 4),
  ('Molho de Tomate Picante', 'Excepteur sint occaecat cupidatat non proident, sunt in culpa.', 3.25, 4, 200, 5),
  ('Noz-Moscada Moída', 'Qui officia deserunt mollit anim id est laborum.', 7.80, 1, 50, 1),
  ('Molho de Mostarda', 'Consectetur adipiscing elit, sed do eiusmod tempor incididunt.', 5.75, 7, 100, 2),
  ('Alho em Pó', 'Ut labore et dolore magna aliqua. Ut enim ad minim veniam.', 6.50, 0, 300, 3),
  ('Salsa Seca', 'Minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.', 2.50, 9, 20, 4),
  ('Molho de Soja Picante', 'Ut aliquip ex ea commodo consequat. Duis aute.', 4.99, 6, 350, 5),
  ...
  ('Molho de Soja Picante', 'Ut aliquip ex ea commodo consequat. Duis aute.', 4.99, 6, 350, 5),
  ('Orégãos Secos', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 3.99, 5, 100, 1),
  ('Molho de Piri-Piri', 'Sed do eiusmod tempor incididunt ut labore et dolore magna.', 4.50, 3, 75, 2),
  ('Canela em Pau', 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.', 6.25, 0, 250, 3),
  ('Paprica Doce', 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.', 8.75, 2, 150, 4),
  ('Molho de Tomate Picante', 'Excepteur sint occaecat cupidatat non proident, sunt in culpa.', 3.25, 4, 200, 5),
  ('Noz-Moscada Moída', 'Qui officia deserunt mollit anim id est laborum.', 7.80, 1, 50, 1),
