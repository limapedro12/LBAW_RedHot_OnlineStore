...
INSERT INTO Produto (nome, descricao, precoAtual, desconto, stock, id_administrador, categoria, destaque) VALUES
  ...
  ('Sementes de Malagueta Jalapeño', 'Sementes de malagueta Jalapeño para cultivar em seu jardim ou horta.', 4.50, 0.85, 100, 1, 'Sementes', true),
  ...
  ('Malagueta Aleppo em Conserva', 'Pimentas Aleppo em conserva, ideais para saladas e aperitivos.', 6.25, 0.55, 90, 1, 'Conservas', false),
  ...
  ('Mix de Pimentas em Conserva', 'Mix de pimentas em conserva para uma explosão de sabores no seu paladar.', 9.75, 0.5, 50, 1, 'Conservas', false),
  ('Malagueta Lemon Drop Seca', 'Malagueta Lemon Drop seca, conhecida por seu sabor cítrico e ardência intensa.', 12.50, 0.70, 35, 1, 'Especiarias', false),
  ...
  ('Pó de Malagueta Ancho', 'Pó de malagueta Ancho, suave e defumado, ótimo para temperar carnes.', 9.99, 0.3, 40, 1, 'Temperos', false),
