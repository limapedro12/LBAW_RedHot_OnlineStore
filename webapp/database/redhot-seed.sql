...
INSERT INTO Produto (nome, descricao, precoAtual, desconto, stock, id_administrador, categoria) VALUES
  ...
  ('Molho de Piri-Piri', 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 4.50, 0.03, 75, 1, 'molho'),
  ('Canela em Pau', 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.', 6.25, 0, 250, 1, 'condimento'),
  ('Paprica Doce', 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.', 8.75, 0.20, 150, 1, 'condimento'),
  ('Molho de Tomate Picante', 'Excepteur sint occaecat cupidatat non proident, sunt in culpa.', 3.25, 0.05, 200, 1, 'molho'),
  ('Noz-Moscada Moída', 'Qui officia deserunt mollit anim id est laborum.', 7.80, 0.10, 50, 1, 'condimento'),
  ('Molho de Mostarda', 'Consectetur adipiscing elit, sed do eiusmod tempor incididunt.', 5.75, 0, 100, 1, 'molho'),
  ('Alho em Pó', 'Ut labore et dolore magna aliqua. Ut enim ad minim veniam.', 6.50, 0, 300, 1, 'condimento'),
  ('Salsa Seca', 'Minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.', 2.50, 0.15, 20, 1, 'condimento'),
  ('Molho de Soja Picante', 'Ut aliquip ex ea commodo consequat. Duis aute.', 4.99, 0.05, 350, 1, 'molho'),
